...
const PAGE_TITLES = {
  ...
  '/invoices': { title: 'Invoices', subtitle: 'Manage and track invoices' },
  '/purchases': { title: 'Purchases', subtitle: 'Manage supplier purchases' },
  '/financial-reports': { title: 'Financial Reports', subtitle: 'Tally-style GST reports' },
